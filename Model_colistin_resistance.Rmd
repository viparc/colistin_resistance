...
$$\begin{align*}
  \frac{dR_c}{dt} &= \beta.\alpha^{E_f(t)}.S_c(t).\frac{R_c(t)}{S_c(t)+R_c(t)} - \gamma.R_c(t) - \nu.R_c(t)\\
  \frac{dS_c}{dt} &= -\beta.\alpha^{E_f(t)}.S_c(t).\frac{R_c(t)}{S_c(t)+R_c(t)} + \gamma.R_c(t)  - \nu.S_c(t)\\
  R_e(t) &= p_R.\frac{R_c(t)}{S_c(t)+R_c(t)} + p_S.\frac{S_c(t)}{S_c(t)+R_c(t)}
\end{align*}$$
