...
if(test_method_comp){
  results_mod1 = test_scenario_1[[4]]
  results_mod7 = test_scenario_1[[5]]
}else{

  results_mod1 = EM_algo(modnum=1, numb_rep_algo=1)

  results_mod7 = EM_algo(modnum=7, numb_rep_algo=1)
  
  test_scenario_1 = list(res_data, results_mod1, results_mod7)
  save(test_scenario_1, file = "C:/Users/Jonathan/Desktop/test_scenario_1.rdata")
}

fitplot(fitted_model = results_mod1[[1]], intro = results_mod1[[3]])
fitplot(fitted_model = results_mod7[[1]], intro = results_mod7[[3]])
...
vec_p = results_mod1[[3]]
vec_p[vec_p == 0] = 1e-7
vec_p[vec_p == 1] = 1-(1e-7)
bbmle::AIC(results_mod1[[1]]) + 2*sum(vec_p * log(vec_p) + (1-vec_p) * log(1-vec_p))

print("IC(H,Q) of model 19:")
vec_p = results_mod7[[3]]
vec_p[vec_p == 0] = 1e-7
vec_p[vec_p == 1] = 1-(1e-7)
bbmle::AIC(results_mod7[[1]]) + 2*sum(vec_p * log(vec_p) + (1-vec_p) * log(1-vec_p))

print("Anova:")
bbmle::anova(results_mod1[[1]], results_mod7[[1]])
...
hist(as.numeric(as.matrix(res_data)), nclass = 15, col = "royalblue4", main = "Histogram of all resistance data", xlab = "Resistance values")
resamu(nwkseff = 8, quantuse=F, lag_amu_init = 1, expo="col", tempo_amu = "step")
...
if(test_method_comp){
  results_mod1 = test_scenario_2[[2]]
  results_mod7 = test_scenario_2[[3]]
}else{
  ...
  test_scenario_2 = list(res_data, results_mod1, results_mod7)
...
print("IC(H,Q) of model 1:")
vec_p = results_mod1[[3]]
vec_p[vec_p == 0] = 1e-7
vec_p[vec_p == 1] = 1-(1e-7)
bbmle::AIC(results_mod1[[1]]) + 2*sum(vec_p * log(vec_p) + (1-vec_p) * log(1-vec_p))

print("IC(H,Q) of model 7:")
vec_p = results_mod7[[3]]
vec_p[vec_p == 0] = 1e-7
vec_p[vec_p == 1] = 1-(1e-7)
bbmle::AIC(results_mod7[[1]]) + 2*sum(vec_p * log(vec_p) + (1-vec_p) * log(1-vec_p))
...
hist(as.numeric(as.matrix(res_data)), nclass = 15, col = "royalblue4", main = "Histogram of all resistance data", xlab = "Resistance values")
resamu(nwkseff = 8, quantuse=F, lag_amu_init = 1, expo="allab", tempo_amu = "step")
...
if(test_method_comp){
  results_mod1 = test_scenario_3[[2]]
  results_mod7 = test_scenario_3[[3]]
}else{
  results_mod1 = EM_algo(modnum=1, numb_rep_algo=1)

  results_mod7 = EM_algo(modnum=7, numb_rep_algo=1)
  
  test_scenario_3 = list(res_data, results_mod1, results_mod7)
...
if(test_method_comp){
  ...
  results_mod1 = test_scenario_5[[4]]
  results_mod4 = test_scenario_5[[5]]
}else{
  ...
  results_mod4 = EM_algo(modnum=4, numb_rep_algo=1)
  
  test_scenario_5 = list(res_data, fit_model_1, fit_model_4, results_mod1, results_mod4)
...
fitplot(fitted_model = results_mod1[[1]], intro = results_mod1[[3]])
fitplot(fitted_model = results_mod4[[1]], intro = results_mod4[[3]])
...
vec_p = results_mod4[[3]]
vec_p[vec_p == 0] = 1e-7
vec_p[vec_p == 1] = 1-(1e-7)
bbmle::AIC(results_mod4[[1]]) + 2*sum(vec_p * log(vec_p) + (1-vec_p) * log(1-vec_p))

print("Anovas:")
bbmle::anova(fit_model_4, results_mod4[[1]])
bbmle::anova(results_mod1[[1]], results_mod4[[1]])
...
if(test_method_comp){
  ...
  results_mod1 = test_scenario_6[[4]]
  results_mod4 = test_scenario_6[[5]]
}else{
  fit_model_1 = rep_est(nrep=20, minusloglrep = run2_intr(0), methodrep = "Nelder-Mead", controlrep = list(maxit = 5000), prev_est = "none", fixedvar = c("lambda1", "lambda2", "alpha", "beta", "teta", "delta", "eta", "Sd"), startvar = c("mu"))
  ...
  test_scenario_6 = list(res_data, fit_model_1, fit_model_4, results_mod1, results_mod4)
...
```{r}
res_data = res_data_saved
rm(res_data_saved, test_scenario_1, test_scenario_2, test_scenario_3, test_scenario_4, test_scenario_5, test_scenario_6, results_mod1, results_mod7, fit_model_1, fit_model_7)
```
...
if(alread_comp){
  ...
  clusterExport(cl, c("effect_recent_amu","almost_one","thresh_res","type_mod","definition_amu","amu_model_is_quanti","E_step","M_step","rep_est","run2","run2_intr","resamu","n_cyc","res_data","weeks_samp","col_expo","col_expo_quanti","allab_expo","allab_expo_quanti"))
