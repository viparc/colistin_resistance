...
#### Assessing the spatial autocorrelation of the probability of introduction
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      radioButtons("decay_fct",
                  "Decay function:",
                  choices = list("Exponential" = "exp", "Threshold" = "thresh", "Next neighbor" = "next_neighbor", "Linear" = "linear"),
                  selected = "exp"),
      radioButtons("pval",
                  "p-value of the test:",
