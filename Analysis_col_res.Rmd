...
```{r}
run2 = function(aim="est", intr=introd, type_mod="linear", mu, lambda1, lambda2, alpha, beta, teta, delta, eta, Sd){
  ...
  if(type_mod == "linear"){
    ...
    if(aim == "est"){
      ...
      return(list(obsdat = obsdat[,c("obsres", "amu_init", "amu_t", "introduc", "predmod", "cycle")], minll = -sum(total_loglik), true_param = c(mu, lambda1, lambda2, alpha, beta, teta, delta, eta, Sd)))
    }
  
  }else if(type_mod == "glm_bin"){
...
run2_intr <- function(x) {
 function(aim="est", type_mod="linear", mu, lambda1, lambda2, alpha, beta, teta, delta, eta, Sd)
   run2(aim, intr=x, type_mod, mu, lambda1, lambda2, alpha, beta, teta, delta, eta, Sd)
}
...
local_moran = function(decay_param, decay_fun, p_val, style_weight){
  ...
  prob_intro_farms$pval[prob_intro_farms$pval >= p_val] = "N.S."
  prob_intro_farms$pval[prob_intro_farms$pval < p_val] = "Significant"
  ...
  prob_intro_farms$cluster[prob_intro_farms$pval == "N.S."] = "N.S."
  ...
  p1 = p1 + blank()
  p1 = p1 + scale_fill_manual("Cluster:", values = c("High-high"="red", "Low-low"="blue", "High-low"="lightpink", "Low-high"="skyblue2", "N.S."="white"))
  ...
  p2 = p2 + scale_fill_manual("Cluster:", values = c("High-high"="red", "Low-low"="blue", "High-low"="lightpink", "Low-high"="skyblue2", "N.S."="white"))
