...
library(ggpubr)
pA = ggplot()
pA = pA  + geom_polygon(data = sf_file_df, aes(x = long, y = lat, group = id, fill = a_weight/Area), col="black", size=0.5)
# pA = pA + geom_point(data = gps_farms, aes(x = Long, y = Lat), col = "black", size = 0.75)
set.seed(78)
pA = pA + geom_jitter(data = prob_intro_farms, aes(x = Long, y = Lat, col = Prob), shape = 16, size = 3, width = 0.006, height = 0.006)
pA = pA + scale_color_gradient2(name = "Probability of unexplained infection:", low = "dodgerblue", mid = "white", high = "red", midpoint = 0.5, limits = c(0, 1))
pA = pA + scale_fill_gradient2(name = "Livestock weight (tonnes) per km²", low = "white", high = "brown")
...
pC = ggplot()
pC = pC  + geom_polygon(data = sf_file_df, aes(x = long, y = lat, group = id, fill = a_weight/Area), col="black", size=0.5)
# pC = pC + geom_point(data = gps_farms, aes(x = Long, y = Lat), col = "black", size = 0.75)
set.seed(78)
pC = pC + geom_jitter(data = prob_intro_farms, aes(x = Long, y = Lat, col = Obs_res), shape = 16, size = 3, width = 0.006, height = 0.006)
pC = pC + scale_color_manual(name = "Observed resistance:", values = c("0" = "dodgerblue", "1" = "red"), labels = c("0" = "Sensitive", "1" = "Resistant"))
pC = pC + scale_fill_gradient2(name = "Livestock weight (tonnes) per km²", low = "white", high = "brown")
