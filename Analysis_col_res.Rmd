...
```{r}
EM_algo <- function(modnum, numb_rep_algo=3, tol=1, max.step=50) {
...
```{r}
prob_intro_farms = data.frame(Farm = resulpar[[7]][[7]], Prob = resulpar[[7]][[3]])
...
We plot a map with the probability of introduction for each observation. (It's possible to shift the dots to plot both observations of a farm side by side.)
