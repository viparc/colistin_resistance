...
if(test_method_comp){
  ...
  fake_obsdat = run2(aim="pred", intr=0, mu=mu_fake, lambda1=0, lambda2=0, alpha=alpha_fake, beta=logit((beta_fake)/4), teta=0, delta=1, eta=0)[["obsdat"]]
  rm(res_data)
...
if(test_method_comp){
  ...
  res_data = res_data_saved
  fake_obsdat = run2(aim="pred", intr=0, mu=mu_fake, lambda1=0, lambda2=0, alpha=0, beta=1, teta=teta_fake, delta=logit((delta_fake-1)/4), eta=0)[["obsdat"]]
  rm(res_data)
  fake_res = fake_obsdat$predmod >=0.5
  fake_amu = fake_obsdat$amu_t
